        ...
        <div className="w-full max-w-7xl animate-fade-in">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
                ...
                <div className="text-center">
                    <h1 className="text-3xl md:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-300">
                        Quita Smart
                    </h1>
                    <p className="text-slate-400 text-sm">A estratégia inteligente para quitar seu imóvel</p>
                </div>
